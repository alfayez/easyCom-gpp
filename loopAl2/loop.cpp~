...
***********************************************************************
Description:
	This function calls the DSPLink functions needed to set up the 
	data channel to transmit data between both processors
***********************************************************************	
Parameters:
	std::string  &dspExecutable = Name of DSP executable
	bufferType   &strBufferSize = the size of the GPP/DSP channel
	int          &processorId   = Unique ID of the attaced DSP
	gnuRadioType *gr_inst       = struct used to pass GNU Radio specific
				      parameters
***********************************************************************	
Returns:
	None
...
***********************************************************************	
Notes:
	This function is called as part of the "LOOP_Main (std::string dsp_prog_name)"
	function which is the main initialization routine.
	
	This function deals only with setting up the data channel buffer
***********************************************************************	
References:
***********************************************************************	
Examples:
...
***********************************************************************
Description:
	This function calls the DSPLink functions needed to start the
	execution of the DSP program
***********************************************************************	
Parameters:
...
Notes:
	...
	This function deals only with starting the DSP execution
***********************************************************************	
References:
***********************************************************************	
Examples:
...
***********************************************************************
Description:
	This function calls the DSPLink functions needed to stop DSP
	execution and deallocate resources called when the DSP was first
	initialized
***********************************************************************	
Parameters:
...
***********************************************************************
Description:
	This function calls intializes the DSP
***********************************************************************	
Parameters:

	std::string dsp_prog_name   = Name of DSP executable
***********************************************************************	
Returns:
	None
***********************************************************************	
...
***********************************************************************	
Notes:
	This is the main DSP initialization routine in the GPP/DSP library
***********************************************************************	
References:
***********************************************************************	
Examples:
...
***********************************************************************
Description:
	This function can be used for debugging purposes where data
	processed on the DSP 
***********************************************************************	
Parameters:

	IN Char8 * buf        = The DSP buffer to be verified
	gnuRadioType *gr_inst = struct used to pass GNU Radio specific
				parameters.  Can be used to pass the 
				buffer with the data to be verified.
...
***********************************************************************
Description:
	This function is sets up some DSP driver settings
***********************************************************************	
Parameters:
	int          &processorId   = Unique ID of the attaced DSP 
***********************************************************************	
...
***********************************************************************
Description:
	This function initializes the struct holding DSP related
	values
***********************************************************************	
Parameters:
	struct dsp *dsp_instance = DSP instance, makes more sense if
				   processor used contains multiple
				   DSP cores
***********************************************************************	
Returns:
	None
...
***********************************************************************
Description:
	This function checks the parameters passed to the DSP setup
***********************************************************************	
Parameters:
	gnuRadioType *gr_inst = struct used to pass GNU Radio specific
				parameters. 
...
Notes:
	...
	This function can be used to ensure ensure that the user is choosing
	valid parameters for the GPP/DSP interface.  The interface currently
	has static settings so this would be more helpful once the interface
	is more dynamic.
***********************************************************************	
References:
***********************************************************************	
...
***********************************************************************
Description:
	This function transmits data from the GPP to the DSP in real
	format with each data point being 16-bit fixed point.
***********************************************************************	
Parameters:
	Uint8 processorId	= unique DSP ID.
	const float *gpp_local  = local GPP buffer
	bufferType &buff_size   = number of data points to be transmitted
	bufferType &scale       = the scale used for floatin/fixed point conversion (2^scale)
	bufferType &input_sig   = 0-> input is floating point and needs to be converted
				  1-> input is fixed point and can be passed as is
	bufferType &output_sig  = 0-> output should be converted to floating point
				  1-> output should be kept as fixed point
	bufferType &interp	= The interpolation factor to be performed on the DSP
	bufferType &decim	= the decimation factor to be performed on the DSP
	bufferType d_ntaps	= the number of taps for the FIR filter
	bufferType &block_id	= the unique DSP block ID associated with this transaction
***********************************************************************	
Returns:
	None
***********************************************************************	
...
***********************************************************************	
Notes:
	This function implements the actual data transmission while
	"transmit_data_dsp_fs" is the function that exernal applications
	would call.
***********************************************************************	
References:
***********************************************************************	
...
***********************************************************************
Description:
	This function transmits data from the GPP to the DSP in complex
	format with each data point being 16-bit fixed point.
***********************************************************************	
Parameters:
	Uint8 processorId	= unique DSP ID.
...
***********************************************************************
Description:
	This function transmits data from the GPP to the DSP in real.  This
	function is currently used to transmit DSP setup parameters this will
	change later where the function used will be "transmit_data_fs"
***********************************************************************	
Parameters:
	Uint8 processorId	= unique DSP ID.
	const float *gpp_local  = local GPP buffer
...
Notes:
	This function implements the actual data transmission while
	"transmit_data_dsp" is the function that exernal applications
	would call.
***********************************************************************	
References:
***********************************************************************	
...
***********************************************************************
Description:
	This function receives data from the GPP to the DSP in real
	format with each data point being 16-bit fixed point.  This
	function is currently used to receive DSP setup information
	this will change later when the function used will only be
	"receive_data_fs".
***********************************************************************	
Parameters:
	Uint8 processorId	= unique DSP ID.
...
***********************************************************************
Description:
	This function receives data from the GPP to the DSP in complex
	format with each data point being 16-bit fixed point. 
***********************************************************************	
Parameters:
	Uint8 processorId	= unique DSP ID.
...
DSP_STATUS receive_data_cs(Uint8 processorId, gr_complex *gpp_local0, bufferType buff_size, bufferType &scale, bufferType &input_sig, bufferType &output_sig, bufferType &block_id)
{
	...
	//	gpp_local0[i].imag() = ((float)temp_short1 / scale_mult);
		...
		printf("(%f) & ", gpp_local0[i].real());
		printf("%d ", temp_short1);
		printf("(%f)\n", gpp_local0[i].imag());

		//printf("TX GPP <--- DSP   [%d]  = %d (%f) & %d (%f)\n", i, temp_short0, gpp_local0[i].real(), temp_short1, gpp_local0[i].imag());
		#endif
...
***********************************************************************
Description:
	wrapper function for "transmit_data" function.  This is the
	function invoked by outside applications.
***********************************************************************	
Parameters:
	const float *gpp_local  = local GPP buffer
	bufferType &buff_size   = number of data points to be transmitted
...
***********************************************************************
Description:
	This is the wrapper function for the function "receive_data".
	This is the function called by outside applications.
***********************************************************************	
Parameters:
	const float *gpp_local  = local GPP buffer
	bufferType &buff_size   = number of data points to be transmitted
...
***********************************************************************
Description:
	It's a wrapper function for "transmit_data_fs"
***********************************************************************	
Parameters:
	Uint8 processorId	= unique DSP ID.
	const float *gpp_local  = local GPP buffer
...
***********************************************************************
Description:
	It's a wrapper function for "receive_data_fs"
***********************************************************************	
Parameters:
	const float *gpp_local  = local GPP buffer
	bufferType &buff_size   = number of data points to be transmitted
...
***********************************************************************
Description:
	It's a wrapper function for "transmit_data_cs"
***********************************************************************	
Parameters:
	const float *gpp_local  = local GPP buffer
	bufferType &buff_size   = number of data points to be transmitted
...
***********************************************************************
Description:
	This function deallocates the resources used by the GPP/DSP
	interface when the DSP was originally initialized
***********************************************************************	
Parameters:
	None
***********************************************************************	
...
***********************************************************************
Description:
	This function locks a mutex indicating that the GPP/DSP 
	interface is currently in use
***********************************************************************	
Parameters:
	None
***********************************************************************	
...
***********************************************************************
Description:
	This function clears a mutex indicating that the GPP/DSP 
	interface is currently not in use
***********************************************************************	
Parameters:
	None
***********************************************************************	
